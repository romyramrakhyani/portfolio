...
async function loadData() {
    ...
    processCommits(); // 1. Group the data
    displayStats();   // 2. Show the numbers
    renderScatterPlot(); // 3. Draw the chart (Make sure this line exists!)
}
